      ...
      >
        <FormControl>
          ...
          <Box sx={{display:"flex"}} >
            ...
            <FormControl sx={{ m: 1, minWidth: 120 ,flex:'1' }}>
              <InputLabel id="demo-simple-select-helper-label">دسته بندی</InputLabel>
              <Select
                labelId="demo-simple-select-helper-label"
                id="demo-simple-select-helper"
          ...
          <Box sx={{display:"flex"}}>
            <TextField label="نام محصول" variant="outlined" value={product.productName} onChange={(event)=>dispatch(editedProduct({...product , productName :event.target.value}))} sx={{  m: 1, minWidth: 120, flex:'1' }}/>
            <TextField label="برند" variant="outlined" value={product.brand} onChange={(event)=>dispatch(editedProduct({...product , brand :event.target.value}))} sx={{ m: 1, minWidth: 120, flex:'1' }}/>
          </Box>
